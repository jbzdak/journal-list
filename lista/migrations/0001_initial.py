...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lista_journal', (
            ('issn', self.gf('django.db.models.fields.CharField')(max_length=9, primary_key=True)),
        ...
        db.send_create_signal('lista', ['Journal'])


    def backwards(self, orm):
        # Deleting model 'Journal'
        db.delete_table('lista_journal')
    ...
    models = {
        'lista.journal': {
            ...
            'issn': ('django.db.models.fields.CharField', [], {'max_length': '9', 'primary_key': 'True'}),
